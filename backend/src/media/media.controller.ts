...
export class MediaController {
  ...
  @Post()
  @ApiOperation({ summary: 'Crear media', description: 'Registra un nuevo ítem multimedia.' })
  ...
  @Get()
  @ApiOperation({ summary: 'Listar media', description: 'Lista paginada de media con filtro opcional por origen.' })
  @ApiQuery({ name: 'source', required: false, enum: MediaSource, description: 'Filtro por origen.' })
  @ApiQuery({ name: 'skip', required: false, description: 'Ítems a saltar.', example: 0 })
  @ApiQuery({ name: 'take', required: false, description: 'Ítems a devolver.', example: 20 })
  @ApiOkResponse({
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Obtener media', description: 'Devuelve un ítem multimedia por su CUID.' })
  ...
  @Patch(':id')
  @ApiOperation({ summary: 'Actualizar media', description: 'Actualiza los metadatos de un ítem multimedia.' })
  @ApiParam({ name: 'id', description: 'CUID del ítem.' })
  ...
  @ApiOperation({ summary: 'Eliminar media', description: 'Elimina un ítem y todas sus vinculaciones en cascada.' })
  @ApiParam({ name: 'id', description: 'CUID del ítem.' })
  ...
  @ApiParam({ name: 'entityType', enum: ['battle', 'war', 'commander'], description: 'Tipo de entidad destino.' })
  ...
  @HttpCode(HttpStatus.NO_CONTENT)
  @ApiOperation({ summary: 'Desvincular media de entidad', description: 'Elimina la asociación entre el ítem y la entidad.' })
  @ApiParam({ name: 'id', description: 'CUID del ítem multimedia.' })
  @ApiParam({ name: 'entityType', enum: ['battle', 'war', 'commander'], description: 'Tipo de entidad.' })
  ...
  @ApiOperation({
    ...
    description: 'Lista todos los ítems vinculados a una entidad, ordenados por el campo order.',
  })
  @ApiParam({ name: 'entityType', enum: ['battle', 'war', 'commander'], description: 'Tipo de entidad.' })
  @ApiParam({ name: 'entityId', description: 'CUID de la entidad.' })
  ...
  @ApiOperation({
    ...
    description: 'Devuelve el ítem marcado como isPrimary=true para la entidad, o null si no existe.',
  })
  @ApiParam({ name: 'entityType', enum: ['battle', 'war', 'commander'], description: 'Tipo de entidad.' })
  @ApiParam({ name: 'entityId', description: 'CUID de la entidad.' })
